...
node $GITHUB_ACTION_PATH/builder/values.js > values.env.yaml
...
node $GITHUB_ACTION_PATH/builder/compile-uses.js

echo "Compiling additional subcharts instances"
node $GITHUB_ACTION_PATH/builder/compile-chart.js
